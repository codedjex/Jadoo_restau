                    ...
                    <form method="post" action="formulaire.php" >
                        ...
                        <div class="formulaire-deux-champs-inline">
                            ...
                            --><div class="formulaire-contact-champ">
                                ...
                                <input name="prenom" type="text" placeholder="Prénom" required  maxlenght="40">
                            </div>
                        </div>
                        <div class="formulaire-contact-champ">
                        ...
                        <div class="formulaire-contact-champ">
                            ...
                            <input name="message" type="text" placeholder="Votre message/demande de réservation" required min="18" >
                        </div>
